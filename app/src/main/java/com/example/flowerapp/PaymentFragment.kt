...
class PaymentFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val transactionList = listOf(
            Transaction("Blush Harmony", "for Girlfriend's Birthday", 100),
            Transaction("Sunlit Serenity", "for Mother's Bouquet", 150),
            Transaction("Spring Serenade", "for John's wedding day", 100)
        )
